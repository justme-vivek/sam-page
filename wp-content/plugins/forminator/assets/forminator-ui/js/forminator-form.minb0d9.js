...
!function(t) {
    ...
    FUI.inputStates = function(e) {
        var o = t(e)
          , i = o.closest("form");
        if (o.is("input") || i.is(".forminator-poll") && (i.is(".forminator-ui") || i.is(".forminator-custom-form")))
            return o.each((function() {
                var e, o;
                e = t(this),
                o = e.closest(".forminator-field"),
                e.mouseover((function(t) {
                    o.addClass("forminator-is_hover"),
                    t.stopPropagation()
                }
                )).mouseout((function(t) {
                    o.removeClass("forminator-is_hover"),
                    t.stopPropagation()
                }
                )),
                function(e) {
                    ...
                    o.focus((function(t) {
                        i.addClass("forminator-is_active"),
                        t.stopPropagation()
                    }
                    )).blur((function(t) {
                        i.removeClass("forminator-is_active"),
                        t.stopPropagation()
                    }
                    ))
                }(this),
...
function(t) {
    "use strict";
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.inputMaterial = function(e) {
        var o = t(e)
          , i = o.closest(".forminator-field")
          , r = i.find(".forminator-label")
          , n = o.closest("form");
        if (o.is("input") || n.is(".forminator-poll") && (n.is(".forminator-ui") || n.is(".forminator-custom-form")))
            return o.parent().hasClass("forminator-input--wrap") || o.wrap('<div class="forminator-input--wrap"></div>'),
            r.length && (r.addClass("forminator-floating--input"),
            i.find(".forminator-input-with-icon").length && r.addClass("forminator-has_icon"),
            i.find(".forminator-input-with-phone").length && (r.addClass("forminator-has_phone"),
            i.find(".intl-tel-input").hasClass("allow-dropdown") && r.addClass("allow-dropdown"))),
            this
    }
}(jQuery),
function(t) {
    "use strict";
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.textareaStates = function(e) {
        var o = t(e)
          , i = o.closest("form");
        if (o.is("textarea") || i.is(".forminator-ui") || i.is(".forminator-custom-form"))
            return o.each((function() {
                var e, o;
                e = t(this),
                o = e.closest(".forminator-field"),
...
function(t) {
    "use strict";
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.textareaMaterial = function(e) {
        var o = t(e)
          , i = o.closest(".forminator-field")
          , r = i.find(".forminator-label")
          , n = o.closest("form");
        if ((o.is("textarea") || n.is(".forminator-ui") || n.is(".forminator-custom-form")) && !o.hasClass("wp-editor-area"))
            return function() {
                if (o.parent().hasClass("forminator-textarea--wrap") || o.wrap('<div class="forminator-textarea--wrap"></div>'),
                r.length) {
                    var t = (0 === r.height() ? 20 : r.height()) + 9;
                    r.addClass("forminator-floating--textarea"),
                    i.css({
                        position: "relative"
                    }),
                    o.val() && i.addClass("forminator-is_filled"),
                    i.hasClass("forminator-is_filled") && i.hasClass("forminator-is_active") || r.css({
                        "padding-top": t + "px"
                    }),
                    o.css({
                        "padding-top": t + "px"
...
function(t) {
    "use strict";
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.radioStates = function(e) {
        var o = t(e)
          , i = o.find("input");
        if (o.is("label") && "radio" === i.prop("type"))
...
function(t) {
    "use strict";
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.checkboxStates = function(e) {
        var o = t(e)
          , i = o.find("input");
        if (o.is("label") && "checkbox" === i.prop("type"))
            return i.each((function() {
                t(this).on("click", (function() {
                    var e = t(this).parent();
...
function(t) {
    "use strict";
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.multiSelectStates = function(e) {
        var o = t(e)
          , i = o.find(".forminator-option")
          , r = i.find("input");
        if (o.is(".forminator-multiselect") && 0 !== i.length)
...
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.select = {},
    FUI.select.escapeJS = function(e) {
    ...
    FUI.select.formatCheckbox = function(t, e) {
        ...
        return t.id && (r = t.id),
        '<label for="' + r + '" class="forminator-checkbox"><input type="checkbox" value="' + o + '" id="' + r + '" ' + (i ? "checked" : "") + ' /><span class="forminator-checkbox-box" aria-hidden="true"></span><span class="forminator-select-label">' + o + "</span></label>"
    }
    ,
    FUI.select2 = function() {
        t(".forminator-custom-form").each((function() {
            ...
            t.each(["bold", "flat", "default", "basic", "material", "none"], (function(r, n) {
                var a, s = "en", d = "Select", l = -1, c = !1;
                e.hasClass("forminator-design--" + n) && i.length && i.each((function() {
                    ...
                    a = !0 === e.data("rtl-support") ? "rtl" : "ltr",
                    d = e.data("placeholder") ? e.data("placeholder") : "Select",
                    s = e.data("language") ? e.data("language") : "en",
                    l = !0 === e.data("search") ? 0 : -1,
                    !0 === e.data("checkbox") ? (c = !0,
                    f += " forminator-dropdown--checkbox") : c = !1,
                    e.prop("multiple") && (f += " forminator-dropdown--multiple"),
                    r.length || (r = t(document.body)),
                    e.FUIselect2(_objectSpread({
                        dir: a,
                        language: s,
                        placeholder: d,
                        dropdownCssClass: f,
                        ...
                        e.data("search-placeholder") ? e.data("select2").$dropdown.find(":input.select2-search__field").prop("placeholder", e.data("search-placeholder")) : e.data("select2").$dropdown.find(":input.select2-search__field").prop("placeholder", e.data("placeholder") ? e.data("placeholder") : "Search"),
                        (e.closest(".hustle-popup").length || e.closest(".hustle-slidein")) && t(document.body).addClass("forminator-hustle-dropdown-fix")
                    }
...
function() {
    ...
    t.Utils.isFocusable = function(t) {
        if (0 < t.tabIndex || 0 === t.tabIndex && null !== t.getAttribute("tabIndex"))
            return !0;
        if (t.disabled)
            return !1;
        switch (t.nodeName) {
    ...
    t.Utils.focusFirstDescendant = function(e) {
    ...
    t.Utils.attemptFocus = function(e) {
        if (!t.Utils.isFocusable(e))
            return !1;
        t.Utils.IgnoreUtilFocusChanges = !0;
        try {
            e.focus()
        } catch (t) {}
        return t.Utils.IgnoreUtilFocusChanges = !1,
    ...
    t.Authentication = function(e, o, i) {
        if (this.dialogNode = document.getElementById(e),
        ...
        if (this.dialogNode.parentNode.classList.contains(n) ? this.backdropNode = this.dialogNode.parentNode : (this.backdropNode = document.createElement("div"),
        this.backdropNode.className = n,
        ...
        "string" == typeof o)
            this.focusAfterClosed = document.getElementById(o);
        else {
            if ("object" !== _typeof(o))
        ...
        this.preNode = this.dialogNode.parentNode.insertBefore(a, this.dialogNode),
        ...
        this.focusFirst ? this.focusFirst.focus() : t.Utils.focusFirstDescendant(this.dialogNode),
    ...
    t.Authentication.prototype.close = function() {
        ...
        0 < t.OpenDialogList.length ? t.getCurrentDialog().addListeners() : document.body.parentNode.classList.remove(t.Utils.dialogOpenClass)
    }
    ,
    ...
    t.Authentication.prototype.trapFocus = function(e) {
        if (!t.Utils.IgnoreUtilFocusChanges) {
            ...
            o.dialogNode.contains(e.target) ? o.lastFocus = e.target : (t.Utils.focusFirstDescendant(o.dialogNode),
            o.lastFocus == document.activeElement && t.Utils.focusLastDescendant(o.dialogNode),
            o.lastFocus = document.activeElement)
        }
    }
    ,
...
function(t) {
    ...
    FUI.slider = function() {
        ...
        function o(t, e, o, i, r) {
            ...
            n.find(".forminator-slider-value-min").html(e),
            a && (i === r ? (n.find(".forminator-slider-separator").hide(),
            n.find(".forminator-slider-value-max").html("")) : (n.find(".forminator-slider-separator").show(),
            n.find(".forminator-slider-value-max").html(o)))
        }
            ...
            !0 !== r.data("init") && (r.slider(_objectSpread(_objectSpread({
                ...
                create: function(t, n) {
                    var a = e(i, c)
                      , d = s ? e(i, f) : null;
                    r.data("init", !0),
                    m.find(".forminator-slider-hidden-min").val(c).change(),
                    s && m.find(".forminator-slider-hidden-max").val(f).change(),
                    o(i, a, d, c, f)
                },
                slide: function(t, r) {
...
function(t) {
    ...
    var e = !1;
    "object" !== _typeof(window.FUI) && (window.FUI = {}),
    FUI.rating = function(o) {
        o.each((function() {
            var e, o = t(this), i = o.attr("id"), r = o.find("option").not(":disabled"), n = r.length, a = o.attr("data-type") || "star", s = o.attr("data-size") || "md", d = Number(o.find("option:selected").val()) || 0, l = t('<div class="forminator-rating-wrapper"></div>'), c = t('<span data-id="' + i + '" data-selected-value="' + d + '" class="forminator-rating-items forminator-rating-' + s + '"></span>');
            for ("true" === (o.attr("data-init") || "false") && o.next(".forminator-rating-wrapper").remove(),
            e = 0; e < n; e++) {
                var f = Number(r.eq(e).val())
            ...
            o.attr("data-selected-value", d),
            o.attr("data-total-value", n),
            l.append(c),
            "true" === o.attr("data-suffix") && c.append('<span class="forminator-rating-suffix">(' + d + "/" + n + ")</span>"),
            o.after(l),
            o.attr("data-init", "true"),
            o.on("change", (function() {
                var e = Number(t(this).val()) || 0
                  , o = t('[data-id="' + i + '"]')
                  , r = o.find(".forminator-rating-suffix");
                o.attr("data-selected-value", e),
                t(this).attr("data-selected-value", e),
                o.children().removeClass("forminator-rating-selected"),
    ...
    FUI.rating.events = function() {
        t(document).on("mouseenter", ".forminator-rating-item", (function() {
            var e = t(this);
            e.siblings().removeClass("forminator-rating-selected"),
            e.prevAll().addBack().addClass("forminator-rating-hover")
        }
        )),
        t(document).on("mouseleave", ".forminator-rating-item", (function() {
            var e = t(this)
              ...
              , i = t("#" + o)
              , r = Number(i.find("option:selected").val());
            e.prevAll().addBack().removeClass("forminator-rating-hover"),
            e.siblings().addBack().each((function() {
                t(this).data("value") <= r ? t(this).addClass("forminator-rating-selected") : t(this).removeClass("forminator-rating-selected")
            }
            ))
        }
        )),
        t(document).on("click", ".forminator-rating-item", (function() {
            ...
            i.attr("data-selected-value", o),
            n.attr("data-selected-value", o),
            e.siblings().removeClass("forminator-rating-selected"),
            e.prevAll().addBack().addClass("forminator-rating-selected"),
            a.length && a.text("(" + o + "/" + i.children().not(".forminator-rating-suffix").length + ")")
        }
        )),
        ...
        t(document).on("keydown", ".forminator-rating", (function(e) {
            ...
            "ArrowUp" !== e.key && "ArrowRight" !== e.key && "ArrowDown" !== e.key && "ArrowLeft" !== e.key || e.preventDefault(),
            ("ArrowUp" === e.key || "ArrowRight" === e.key) && r < i.length - 1 ? i.eq(r + 1).prop("selected", !0).trigger("change") : ("ArrowDown" === e.key || "ArrowLeft" === e.key) && 0 < r && i.eq(r - 1).prop("selected", !0).trigger("change")
        }
        ))
    }
}(jQuery);
