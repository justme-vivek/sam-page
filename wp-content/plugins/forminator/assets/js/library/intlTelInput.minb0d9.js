...
(function(factory) {
  ...
  var factoryOutput = ( () => {
      ...
      var z = 0
        ...
        , v = l => l.replace(/\D/g, "")
        , A = (l="") => l.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase()
        , S = l => {
          let t = v(l);
          if (t.charAt(0) === "1") {
              let e = t.substr(1, 3);
        ...
        , _ = class {
          ...
          _init() {
              ...
              this.d.separateDialCode && (this.d.allowDropdown = !0,
          ...
          _f() {
              ...
              let {allowDropdown: t, separateDialCode: e, showFlags: i, containerClass: n, hiddenInput: s, dropdownContainer: o, fixDropdownWidth: r, useFullscreenPopup: u, countrySearch: h, i18n: g} = this.d
                , d = "iti";
              ...
              if (this.a.parentNode?.insertBefore(p, this.a),
              t || i) {
                  this.k = c("div", {
                      class: "iti__country-container"
                  }, p),
                  t ? (this.selectedCountry = c("button", {
                      type: "button",
                  ...
                  this.a.disabled && this.selectedCountry.setAttribute("disabled", "true")) : this.selectedCountry = c("div", {
                      class: "iti__selected-country"
                  }, this.k);
                  let m = c("div", {
                      class: "iti__selected-country-primary"
                  }, this.selectedCountry);
                  if (this.l = c("div", null, m),
                  this.selectedCountryA11yText = c("span", {
                  ...
                  t) {
                      ...
                      this.searchResultsA11yText = c("span", {
                          class: "iti__a11y-text"
                      }, this.dropdownContent)),
                      this.countryList = c("ul", {
              ...
              if (p.appendChild(this.a),
              s) {
                  let m = this.a.getAttribute("name") || ""
                    , C = s(m);
                  C.phone && (this.hiddenInput = c("input", {
                      type: "hidden",
                      name: C.phone
                  }),
                  p.appendChild(this.hiddenInput)),
                  C.country && (this.hiddenInputCountry = c("input", {
                      type: "hidden",
                      name: C.country
                  }),
          ...
          _g() {
              for (let t = 0; t < this.p.length; t++) {
                  ...
                  let s = "";
                  this.d.showFlags && (s += `<div class='iti__flag-box'><div class='iti__flag iti__${e.iso2}'></div></div>`),
          ...
          _i4() {
              a.autoCountry ? this.handleAutoCountry() : a.startedLoadingAutoCountry || (a.startedLoadingAutoCountry = !0,
              typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup( (t="") => {
                  let e = t.toLowerCase();
                  e && this._y(e, !0) ? (a.autoCountry = e,
          ...
          _j() {
              let {strictMode: t, formatAsYouType: e, separateDialCode: i, formatOnDisplay: n} = this.d
                , s = !1;
              ...
              this._a12 = r => {
                  ...
                  if (e && !s && !g) {
                      let d = this.a.selectionStart || 0
                        ...
                        , L = j(m, y, d, C);
                      this.a.value = y,
                      this.a.setSelectionRange(L, L)
                  }
              }
              ,
              this.a.addEventListener("input", this._a12),
              (t || i) && (this._handleKeydownEvent = r => {
                  if (r.key && r.key.length === 1 && !r.altKey && !r.ctrlKey && !r.metaKey) {
                      ...
                      if (t) {
                          let u = this.a.selectionStart === 0 && r.key === "+"
                            ...
                            , C = this.a.value.substring(this.a.selectionStart, this.a.selectionEnd)
                            , y = /\d/.test(C);
          ...
          _v(t) {
              ...
              if (o) {
                  ...
                  i.charAt(0) === "+" && r.length ? u = "" : (!i || i === "+") && !this.s.iso2 && (u = this.j);
          ...
          _z(t) {
              ...
              this.l) {
                  ...
                  r = `${this.s.name} +${this.s.dialCode}`) : (o = "iti__flag iti__globe",
                  r = n.noCountrySelected),
                  this.l.className = o,
              ...
              if (t && a.utils)
                  if (this.s.iso2) {
                      let n = a.utils.numberType[e]
                        ...
                        , o = s;
                      for (; a.utils.isPossibleNumber(s, this.s.iso2, i); )
                          o = s,
                          s += "0";
          ...
          handleAutoCountry() {
              this.d.initialCountry === "auto" && a.autoCountry && (this.j = a.autoCountry,
              this.s.iso2 || this.l.classList.contains("iti__globe") || this.setCountry(this.j),
              this.h())
          }
          handleUtils() {
              a.utils && (this.a.value && this._u(this.a.value),
              this.s.iso2 && (this._0(),
              this._updateMaxLength())),
              this.i0()
          }
          ...
          _utilsIsPossibleNumber(t) {
              return a.utils ? a.utils.isPossibleNumber(t, this.s.iso2, this.d.validationNumberType) : null
          }
        ...
        , B = l => !a.utils && !a.startedLoadingUtilsScript ? (a.startedLoadingUtilsScript = !0,
      new Promise( (t, e) => {
